            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h3><i class="fa fa-list"></i> Assignment Dashboard </h3> <br>
                        <button @click="initAddTask()" class="btn btn-sm btn-outline-success float-right" style="padding:5px">
                        ...
                        <table class="table table-bordered " v-if="tasks.length > 0">
                            ...
                            <tr v-for="(task, index) in tasks">
                                ...
                                <td>
                                    ...
                                    <button @click="deleteTask(index)" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button>
                                </td>
                            </tr>
                            </tbody>
                        </table>
